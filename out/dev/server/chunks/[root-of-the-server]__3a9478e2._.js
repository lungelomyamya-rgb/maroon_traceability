...
function proxy(request) {
    ...
    if (publicRoutes.some((route)=>pathname.startsWith(route)) || staticFiles.some((staticFile)=>pathname.startsWith(staticFile)) || staticFiles.some((staticFile)=>new RegExp(staticFile).test(pathname))) {
