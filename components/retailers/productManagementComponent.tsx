    ...
    const mockProducts: Product[] = [
      {
        ...
        batchCode: 'BATCH-001',
        qualityGrade: 'A',
        images: ['/maroon_traceability/images/moringaPowder.jpg'],
      ...
      },
      {
        ...
        batchCode: 'BATCH-002',
        qualityGrade: 'A',
        images: ['/maroon_traceability/images/moringaTea.jpg'],
      ...
      },
      {
        ...
        description: 'Cold-pressed organic moringa oil',
      ...
      {
        id: 'prod5',
        name: 'Moringa Seeds - Premium Pack',
        category: 'Seeds',
        price: 35.00,
        ...
        qualityGrade: 'A',
        images: ['/images/placeholder.jpg'],
        description: 'Premium quality moringa seeds for planting',
        tags: ['seeds', 'planting', 'heirloom'],
      ...
      {
        id: 'prod6',
        name: 'Moringa Energy Drink Mix - 300g',
        category: 'Powders',
        price: 55.00,
        ...
        qualityGrade: 'B',
        images: ['/images/placeholder.jpg'],
        description: 'Natural energy drink mix with moringa powder',
        tags: ['energy', 'drink', 'natural'],
      ...
      {
        id: 'prod7',
        name: 'Moringa Herbal Tea Blend - 25 Bags',
        category: 'Teas',
        price: 52.00,
        ...
        qualityGrade: 'A',
        images: ['/images/placeholder.jpg'],
        description: 'Blend of moringa with herbal teas',
        tags: ['herbal', 'blend', 'antioxidant'],
      ...
      },
      {
        ...
        qualityGrade: 'A',
        images: ['/images/placeholder.jpg'],
        description: 'Anti-aging face serum with moringa extract',
