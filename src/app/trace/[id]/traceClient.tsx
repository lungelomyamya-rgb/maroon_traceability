...
export default function TraceClient({ id }: TraceClientProps) {
  ...
  const [product, setProduct] = useState<BlockchainRecord | null>(null);
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800">Maroon Blockchain</h1>
              <p className="text-xs text-gray-500">Verified Supply Chain</p>
            </div>
          </div>
        </div>
      </header>
