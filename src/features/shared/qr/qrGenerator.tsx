  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 transition-all duration-200 hover:shadow-xl">
      <div className="text-center mb-6">
        <h3 className="text-lg font-semibold text-gray-900 transition-all duration-200 hover:scale-105">QR Code Generator</h3>
      ...
      <div className="space-y-4">
        ...
        {showPreview && qrData && (
          <div className="space-y-4">
            {/* Mock QR Code Visual */}
            <div className="flex justify-center transition-all duration-200 hover:scale-105">
              <div className="p-4 bg-white border-2 border-gray-300 rounded-lg shadow-sm hover:shadow-md">
            ...
            <div className="bg-blue-50 p-3 rounded-lg transition-all duration-200 hover:shadow-md">
