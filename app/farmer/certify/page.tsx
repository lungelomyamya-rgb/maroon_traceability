          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div>
                <Label htmlFor="productName">
                  Product Name <span className={`${commonColors.red800}`}>*</span>
                </Label>
                <Input
                  id="productName"
              ...
              <div>
                <Label>
                  Product Category <span className="${commonColors.red800}">*</span>
                </Label>
                <div className="relative">
                  <select
              ...
              <div>
                <Label htmlFor="batchNumber">
                  Batch Number <span className="${commonColors.red800}">*</span>
                </Label>
                <Input
                  id="batchNumber"
              ...
              <div className="space-y-1">
                <Label className="text-sm">
                  Production Date <span className={`${commonColors.red800}`}>*</span>
                </Label>
                <div className="relative">
                  <Input
                    type="text"
              ...
              <div className="space-y-1">
                <Label htmlFor="quantity" className="text-sm">
                  Quantity <span className="${commonColors.red800}">*</span>
                </Label>
                <Input
                  type="number"
                  id="quantity"
              ...
              <div className="space-y-1">
                <Label htmlFor="unit" className="text-sm">
                  Unit <span className="${commonColors.red800}">*</span>
                </Label>
                <div className="relative">
                  <select
                    value={formData.unit}
                    onChange={(e) => setFormData({...formData, unit: e.target.value})}
                    className={`flex h-9 w-full appearance-none rounded-md border border-gray-300 bg-white pl-2.5 pr-7 py-1.5 text-sm ${textColors.primary} focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:cursor-not-allowed disabled:opacity-50`}
                    required
                  >
            ...
            <div className="pt-4">
              ...
              <DocumentVerification 
                ...
                documentTypes={productCertificationDocs.map(doc => ({ value: doc.value as any, label: doc.label }))}
                required={true}
