  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 pt-16 sm:pt-20 pb-8 sm:pb-16">
          <div className="text-center px-2 sm:px-4 lg:px-8">
            ...
            <div className="mb-4 sm:mb-6 lg:mb-8 flex justify-center px-1 sm:px-2">
              <img 
                src="/maroon_traceability/images/heroImage.png" 
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h3 className="text-xl sm:text-2xl text-blue-600 font-semibold mb-4 sm:mb-6 lg:mb-8">
              But Right Now, It's Vulnerable.
            </h3>
            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 lg:mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-10 lg:mb-12">
            <div className="bg-red-50 border border-red-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
              <div className="flex items-center mb-4">
                <Lock className="h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 text-red-600 mr-2 sm:mr-3" />
                <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Stock Theft</h4>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
              <div className="flex items-center mb-4">
                <TrendingUp className="h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 text-blue-600 mr-2 sm:mr-3" />
                <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Lower Prices</h4>
              </div>
              <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-700 mb-8 sm:mb-10 lg:mb-12 max-w-4xl mx-auto">
              Maroon provides each animal with a digital identity that confirms:
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-10 lg:mb-12">
            <div className="text-center">
              <div className="bg-blue-100 rounded-full p-3 sm:p-4 lg:p-6 w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 mx-auto mb-3 sm:mb-4 lg:mb-6 flex items-center justify-center">
                <Users className="h-4 w-4 sm:h-6 sm:w-6 lg:h-10 lg:w-10 text-blue-600" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Who owns it</h3>
              <p className="text-sm sm:text-base text-gray-600">Clear, verifiable ownership records</p>
            </div>

            <div className="text-center">
              <div className="bg-blue-100 rounded-full p-3 sm:p-4 lg:p-6 w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 mx-auto mb-3 sm:mb-4 lg:mb-6 flex items-center justify-center">
                <Award className="h-4 w-4 sm:h-6 sm:w-6 lg:h-10 lg:w-10 text-blue-600" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">How it was raised</h3>
              <p className="text-sm sm:text-base text-gray-600">Complete care and treatment history</p>
            </div>

            <div className="text-center">
              <div className="bg-blue-100 rounded-full p-3 sm:p-4 lg:p-6 w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 mx-auto mb-3 sm:mb-4 lg:mb-6 flex items-center justify-center">
                <Shield className="h-4 w-4 sm:h-6 sm:w-6 lg:h-10 lg:w-10 text-blue-600" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Where it comes from</h3>
              <p className="text-sm sm:text-base text-gray-600">Verified origin and location records</p>
            </div>
          </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">How It Works</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-2 sm:px-4 lg:px-8">
            <div className="text-center">
              <div className="mb-4 sm:mb-6 flex justify-center">
                <img 
                  src="/maroon_traceability/images/howItWorks1.png" 
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Step 1: Tag Your Animal</h3>
            ...
            <div className="text-center">
              <div className="mb-4 sm:mb-6 flex justify-center">
                <img 
                  src="/maroon_traceability/images/howItWorks2.png" 
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Step 2: Record What Matters</h3>
              <p className="text-xs sm:text-sm md:text-base text-gray-600">
            ...
            <div className="text-center">
              <div className="mb-4 sm:mb-6 flex justify-center">
                <img 
                  src="/maroon_traceability/images/howItWorks3.png" 
                  alt="Step 3: Show, Don't Tell" 
                  className="w-full max-w-40 sm:max-w-48 md:max-w-xs lg:max-w-sm h-32 sm:h-36 md:h-40 lg:h-48 object-contain rounded-lg shadow-md"
                />
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Step 3: Show, Don't Tell</h3>
              <p className="text-xs sm:text-sm md:text-base text-gray-600">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">Who Maroon Is For?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">Communal & Rural Farmers</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center">
                  <Shield className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Protect your family's wealth</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Digital proof of ownership</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Something to show to police, insurers, or banks</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">Emerging Commercial Farmers</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center">
                  <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Access premium markets</span>
                </div>
                <div className="flex items-center">
                  <Award className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Command better prices with verified traceability</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Build your brand reputation</span>
                </div>
                <div className="flex items-center">
                  <Shield className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base text-gray-700">Meet export and retail requirements</span>
                </div>
              </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">This Is Not Just Software</h2>
            <h3 className="text-lg sm:text-xl lg:text-2xl text-orange-600 font-semibold mb-4 sm:mb-6 lg:mb-8">This Is About Protection. Trust. Access.</h3>
          </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">The Maroon Digital Agri-Asset Book</h2>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
              ...
              <div className="text-center p-3 sm:p-4 lg:p-6 bg-orange-50 rounded-lg">
                ...
                <p className="text-xs sm:text-sm text-gray-600">Clear, verifiable ownership</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6">Why Farmers Choose Maroon</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            <div className="text-center p-3 sm:p-4 lg:p-6 bg-gray-50 rounded-lg">
              <Shield className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-orange-600 mx-auto mb-2 sm:mb-3 lg:mb-4" />
            ...
            <div className="text-center p-3 sm:p-4 lg:p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs sm:text-sm text-gray-600">Your protection is our priority</p>
            </div>
          </div>

          <div className="text-center mt-6 sm:mt-8 lg:mt-12">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600">Your Herd Is Your Legacy!</h3>
          </div>
        </div>
      </div>
