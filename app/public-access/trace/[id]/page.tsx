...
export default function PublicTracePage() {
  ...
  const [product, setProduct] = useState<PublicTraceProduct | null>(null);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockProduct: PublicTraceProduct = {
        id: params.id as string,
        productName: 'Organic Apples',
        description: 'Fresh organic apples from Green Valley Farm, grown without pesticides and certified organic.',
      ...
      const mockEvents: PublicTraceEvent[] = [
        {
          ...
          notes: 'Planted 1000 organic apple seedlings using sustainable farming practices',
          photos: [],
          syncStatus: 'synced',
          data: {}
        },
        {
          ...
          location: 'Field A, Green Valley Farm',
          notes: 'Healthy growth observed, no pests detected, organic pest control methods working effectively',
          photos: [],
          syncStatus: 'synced',
          data: {}
        },
        {
          ...
          location: 'Field A, Green Valley Farm',
          notes: 'Harvested 500kg of premium organic apples, all quality standards met',
          photos: [],
          syncStatus: 'synced',
          data: {}
        },
        {
          ...
          notes: 'Passed all quality checks. Grade A+ quality, no chemical residues detected',
          photos: [],
          syncStatus: 'synced',
          data: {}
        },
        ...
        },
        {
          ...
          location: 'Packaging Facility, Cape Town',
          notes: 'Packaged in organic-certified materials, batch codes applied',
          photos: [],
          syncStatus: 'synced',
          data: {}
        },
        {
          ...
          location: 'Fresh Market, Cape Town',
      ...
      >
          ...
          <main className="max-w-4xl mx-auto px-4 py-8 flex-1">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
              <div className={`${categoryColor.bg} p-4 border-b relative h-32`}>
                ...
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className={`px-2 py-1 rounded-full text-xs font-semibold ${categoryColor.bg} ${categoryColor.text} border-2 border-current`}>
                        {product.category}
                      </span>
